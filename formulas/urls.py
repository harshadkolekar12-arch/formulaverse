...
urlpatterns=[
    ...
    path('formula/<slug:slug>/comment/', views.add_comment, name='add_comment'),
    path("formula/<int:pk>/", views.redirect_old_formula_id, name="legacy-formula-id"),
    ...
    path('all-cheatsheet-pdf/', views.MasterCheatsheetPDFView.as_view(), name='all-cheatsheet'),
